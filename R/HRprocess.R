...
HRprocess<-function(cenac, utm, ll, h=500, ext=2, grid=200, sub="%Y-%m", cont=c(50,95), type="MCP", cumulative=FALSE, storepoly=FALSE, div=4){

  suppressPackageStartupMessages({sapply(c("maptools", "maps", "adehabitatHR", "sp", "raster", "rasterVis", "dplyr", "lubridate", "rgeos"), require, character.only=TRUE)})
