...
tagdata<-read.csv("~/Downloads/TigerShark_IMOSdata.csv")
tag1<-tagdata[tagdata$tag_id%in%51448725,]
taginfo<-read.csv("/Users/vinayudyawer/Dropbox/PostDoc/IMOS Task Team/2. SpComp Analysis/ATF SpComp Analysis/TagMetadata.txt", sep=";")
statinfo<-read.csv("/Users/vinayudyawer/Dropbox/PostDoc/IMOS Task Team/2. SpComp Analysis/ATF SpComp Analysis/StationReceiverDeployment.csv", sep=";")
