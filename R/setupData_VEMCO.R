...
#'
#'@description Sets up and stores all relevant information required for spatio-temporal analyses from VEMCO VUE exports.
...
#'
#' ## Setup data
#' ATTdata<- setupData(Tag.Detections = VEMCOdata, Tag.Metadata = taginfo, Station.Information = statinfo)
#' ATTdata
#'
#'
setupData_VEMCO<-function(Tag.Detections, Tag.Metadata, Station.Information, tz="UTC", crs=NULL){
